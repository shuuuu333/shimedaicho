...
export const IcoReg = () => <svg {...base(21)} strokeWidth={1.8} strokeLinejoin="round"><rect x="3" y="7.5" width="18" height="13" rx="2.5" /><path d="M6.5 7.5V5a1.5 1.5 0 0 1 1.5-1.5h8A1.5 1.5 0 0 1 17.5 5v2.5M3 12h18" /><circle cx="7.5" cy="16.5" r="1.2" fill="currentColor" stroke="none" /><circle cx="12" cy="16.5" r="1.2" fill="currentColor" stroke="none" /><circle cx="16.5" cy="16.5" r="1.2" fill="currentColor" stroke="none" /></svg>;
